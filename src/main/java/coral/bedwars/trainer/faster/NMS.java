...
public class NMS {
    ...
    public static final Field PLAYER_SCORES, PLAYER_CONNECTION;
    public static final Constructor<?> PACKET_SCORE_REMOVE, PACKET_SCORE, SB_SCORE, PACKET_OBJ, PACKET_DISPLAY;
    public static final Object ENUM_SCORE_ACTION_CHANGE, ENUM_SCORE_ACTION_REMOVE;
    public static final Method SB_SCORE_SET, SEND_PACKET;
    ...
    static {
        ...
        try {
            ...
            Spigot.log("Error while loading NMS methods. (Unsupported Minecraft version?)");
        }
    ...
    private static Map<Class<?>, Method> handles = Maps.newHashMap();
    ...
    public static void sendPacket(Object packet, Player... players) {
        for(Player p : players) {
            try {
                ...
                Spigot.log("Error while sending packet to player. (Unsupported Minecraft version?)");
            }
        }
    }
    ...
    public static class Version {
        ...
        private final String name, major, minor;
